<div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 pb-4 text-white min-vh-100 sticky-top"
    ...
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
        <!-- <img src="{{ asset('Images/school-logo.png') }}" style="width: 50px" alt="">  -->
        <span class="fs-4 fw-bold">{{env('APP_NAME') }}</span>
    </a>
    <ul class="nav nav-pills flex-column mb-auto mt-3">
        <li class="nav-item">
            <a href="{{ route('homepage') }}" class="nav-link link-dark fs-5">
                <i class="bi bi-house-door-fill pe-4"></i>Home
            </a>
        </li>

        <li>
            <a href="{{ route('class.list') }}" class="nav-link link-dark fs-5">
                <i class="bi bi-people-fill pe-4"></i>Class
            </a>
        </li>
        <li>
            <a href="{{ route('subject.mysubject') }}" class="nav-link link-dark fs-5">
    ...
    <div class="dropdown">
        <a href="#" class="d-flex align-items-center link-dark text-decoration-none dropdown-toggle nav-link fs-5"
            ...
            <i class="bi bi-person-fill pe-2"></i><strong>{{ Auth::user()->name }}</strong>
        </a>
